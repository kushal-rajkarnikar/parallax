...
$(document).ready(function() {
 ...
 $('#fullpage').fullpage({
  sectionsColor: ['#32364c', '#265756', '#9874ba'],
            ...
            navigation: true,
            navigationTooltips: ["Home", "Level up your SMS Game", "It's as easy as", "We've got you covered"],        
          });

 $(".type-text").typed({
  strings: ["<span id='color-1'>Voting</span>", "<span id='color-2'>API</span>", "<span id='color-3'>Campaigns</span>", "<span id='color-1'>Alerts</span>"],
  typeSpeed: 150,
  backDelay: 2000, 
  loop: true           
});

      //  var owl = $("#level-slider");

      $("#level-slider").owlCarousel({
        items: 1,
        slideSpeed : 1000,
        navigation: false
      });
      $("#level-slider").trigger('owl.next');      
      $(".next").click(function(){         
      });
      $(".prev").click(function(){
        $("#level-slider").trigger('owl.prev');
      });
    });
